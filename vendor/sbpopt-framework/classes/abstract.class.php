 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Abstract' ) ) {
  abstract class SBPOPT_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        SBPOPT::$css = apply_filters( "sbpopt_{$this->unique}_output_css", SBPOPT::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'SBPOPT_Field_' . $field_type;
