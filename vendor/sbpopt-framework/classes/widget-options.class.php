 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Widget' ) ) {
  class SBPOPT_Widget extends WP_Widget {
    ...
    public function __construct( $key, $params ) {
      ...
      $this->unique = $key;
      $this->args   = apply_filters( "sbpopt_{$this->unique}_args", wp_parse_args( $params, $this->args ), $this );
      ...
      // Set filters
      $widget_ops  = apply_filters( "sbpopt_{$this->unique}_widget_ops", $widget_ops, $this );
      $control_ops = apply_filters( "sbpopt_{$this->unique}_control_ops", $control_ops, $this );
    ...
    public function form( $instance ) {
      ...
      if ( ! empty( $this->args['fields'] ) ) {
        ...
        echo '<div class="sbpopt sbpopt-widgets sbpopt-fields'. esc_attr( $class ) .'">';
        ...
        foreach ( $this->args['fields'] as $field ) {
          ...
          SBPOPT::field( $field, $this->get_widget_value( $instance, $field ), $field_unique );
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $new_instance = apply_filters( "sbpopt_{$this->unique}_save", $new_instance, $this->args, $this );

      do_action( "sbpopt_{$this->unique}_save_before", $new_instance, $this->args, $this );
