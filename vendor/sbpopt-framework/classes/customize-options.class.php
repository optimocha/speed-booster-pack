 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Customize_Options' ) ) {
  class SBPOPT_Customize_Options extends SBPOPT_Abstract {
    ...
    public function add_customize_save_after( $wp_customize ) {
      do_action( "sbpopt_{$this->unique}_save_before", $this->get_options(), $this, $wp_customize );
      do_action( "sbpopt_{$this->unique}_saved", $this->get_options(), $this, $wp_customize );
      do_action( "sbpopt_{$this->unique}_save_after", $this->get_options(), $this, $wp_customize );
    }
    ...
    public function add_customize_options( $wp_customize ) {
      ...
      if ( ! class_exists( 'WP_Customize_Panel_SBPOPT' ) ) {
        SBPOPT::include_plugin_file( 'functions/customize.php'  );
      }
      ...
      foreach ( $this->pre_sections as $section ) {
        ...
        if ( ! empty( $section['subs'] ) ) {
          ...
          $wp_customize->add_panel( new WP_Customize_Panel_SBPOPT( $wp_customize, $panel_id, array(
    ...
    public function add_section( $wp_customize, $section_id, $section_args, $panel_id ) {
      ...
      if ( ! empty( $section_args['assign'] ) ) {
        ...
        $wp_customize->add_section( new WP_Customize_Section_SBPOPT( $wp_customize, $section_id, array(
      ...
      if ( ! empty( $section_args['fields'] ) ) {
        ...
        foreach ( $section_args['fields'] as $field ) {
          ...
          $wp_customize->add_control( new WP_Customize_Control_SBPOPT( $wp_customize, $setting_id,
