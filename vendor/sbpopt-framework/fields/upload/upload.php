 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Field_upload' ) ) {
  class SBPOPT_Field_upload extends SBPOPT_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="sbpopt--preview'. esc_attr( $preview_hidden ) .'">';
      ...
      echo '<a href="#" class="button button-primary sbpopt--button" data-library="'. esc_attr( $library ) .'">'. $args['button_title'] .'</a>';
      echo '<a href="#" class="button button-secondary sbpopt-warning-primary sbpopt--remove'. esc_attr( $hidden ) .'">'. $args['remove_title'] .'</a>';
      echo '</div>';
