 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Field_color' ) ) {
  class SBPOPT_Field_color extends SBPOPT_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="sbpopt-color"'. $default_attr . $this->field_attributes() .'/>';
