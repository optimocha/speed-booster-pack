 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Field_sortable' ) ) {
  class SBPOPT_Field_sortable extends SBPOPT_Fields {
    ...
    public function render() {
      ...
      echo '<div class="sbpopt-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="sbpopt-sortable-item">';

          echo '<div class="sbpopt-sortable-content">';
          ...
          SBPOPT::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="sbpopt-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
