 ...
 *
 */
if ( ! class_exists( 'SBPOPT_Field_textarea' ) ) {
  class SBPOPT_Field_textarea extends SBPOPT_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( SBPOPT::$shortcode_instances ) ) ? SBPOPT::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary sbpopt-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
