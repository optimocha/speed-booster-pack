...
* MIT License
*
* Customized by Sbpopt
*
*/
(function($) {

  function SBPOPTAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SBPOPTAjaxChosen.prototype.init = function() {
  ...
  SBPOPTAjaxChosen.prototype.events = function() {
  ...
  SBPOPTAjaxChosen.prototype.search_field_focused = function() {
  ...
  SBPOPTAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SBPOPTAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('sbpopt-chosen', _this.options.data).done( function( response ) {
  ...
  SBPOPTAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.sbpopt-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SBPOPTChosenOrder($hidden_value, true);
  ...
  $.fn.SBPOPTAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SBPOPTAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SBPOPTAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SBPOPTAbstractChosenOrder = (function() {

    function SBPOPTAbstractChosenOrder() {}

    SBPOPTAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SBPOPTAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SBPOPTAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SBPOPTAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SBPOPTAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SBPOPTAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SBPOPTAbstractChosenOrder.SBPOPTChosenOrder = function(select, order, force) {
    ...
    return SBPOPTAbstractChosenOrder;
  ...
  $.fn.extend({
    SBPOPTChosenOrder: function(order, force) {
      return _SBPOPTChosenOrder.SBPOPTChosenOrder(this, order, force);
    }
  });

  this._SBPOPTChosenOrder = (function(_super) {
    __extends(_SBPOPTChosenOrder, _super);

    function _SBPOPTChosenOrder() {
      _ref = _SBPOPTChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SBPOPTChosenOrder.relAttributeName = 'data-option-array-index';

    _SBPOPTChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SBPOPTChosenOrder.getDOMElement = function(element) {
    ...
    _SBPOPTChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SBPOPTChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SBPOPTChosenOrder;

  })(SBPOPTAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('sbpopt-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('sbpopt-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Sbpopt: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Sbpopt: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSBPOPT = FormSerializer.serializeObject;
    $.fn.serializeJSONSBPOPT   = FormSerializer.serializeJSON;
  }
