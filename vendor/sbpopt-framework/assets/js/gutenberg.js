 ...
 * -----------------------------------------------------------
 *
 * Sbpopt Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.sbpopt_gutenberg_blocks ) { return; }

  Object.values(window.sbpopt_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'sbpopt-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary sbpopt-shortcode-button',
              onClick: function () {
                window.sbpopt_gutenberg_props = props;
              },
            }, block.button_title ),
