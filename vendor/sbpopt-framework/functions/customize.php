 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Panel_SBPOPT' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_SBPOPT extends WP_Customize_Panel {
    public $type = 'sbpopt';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_SBPOPT' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_SBPOPT extends WP_Customize_Section {
    public $type = 'sbpopt';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_SBPOPT' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_SBPOPT extends WP_Customize_Control {
    ...
    public function render() {
      ...
      if ( ! empty( $this->field['dependency'] ) ) {
        ...
        $visible  = ' sbpopt-dependency-control';
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'sbpopt_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      $class      = ( $is_complex || $custom ) ? ' sbpopt-customize-complex' : '';
      ...
      echo '<div class="sbpopt-customize-field'. esc_attr( $class ) .'"'. $atts .'>';

      SBPOPT::field( $this->field, $this->value(), $this->unique, 'customize' );
