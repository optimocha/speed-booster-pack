...
class Cache
{
     ...
     * @return bool
     */
    protected function should_bypass_cache($skipped_conditions = []): bool
    {
     ...
     * @return string
     */
    private function get_cache_file_path(string $post_url = null, bool $is_mobile = false)
    {
     ...
     * @param bool $wp_cache
     */
    public static function set_wp_cache_constant(bool $wp_cache = true)
    {
...
//		add_action( 'delete_term', [ $this, 'clear_total_cache' ] );  // When a term is deleted.
    ...
    private function check_query_strings()
    {
        ...
        if (!empty($_GET)) {
            ...
            if (!empty($query_string_file_name)) {
