...
class Tweaks
{
    ...
    {
        if (is_admin() || !sbp_get_option('trim_query_strings')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('dequeue_emoji_scripts') || is_admin()) {
            return;
        }
    ...
    public function disable_emojis_dns_prefetch(array $urls, string $relation_type)
    {
    ...
    {
        if (!sbp_get_option('disable_self_pingbacks')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('dequeue_dashicons')) {
            return;
        }
    ...
    private function autosave_interval()
    {
        ...
        if (empty($autosave_interval) || !(int)$autosave_interval || defined('AUTOSAVE_INTERVAL')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('dequeue_block_library')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('dequeue_global_styles')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('disable_post_embeds')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('instant_page')) {
            return;
        }
    ...
    {
        if (!sbp_get_option('dequeue_comment_reply_script')) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_shortlinks']) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_adjacent_posts_links']) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_wlw']) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_rsd']) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_rest_api_links']) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_feed_links']) {
            return;
        }
    ...
    {
        if (!is_array(sbp_get_option('declutter_head')) || !sbp_get_option('declutter_head')['declutter_wp_version']) {
            return;
        }
