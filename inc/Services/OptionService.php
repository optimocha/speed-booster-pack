<?php
/**
 * This class is responsible for registering admin options.
 *
 * @since      5.0.0
...
class OptionService {
	...
	public function __construct() {
		...
		add_action( 'csf_loaded', [ $this, 'createSettingsPage' ] );
	}
		...
		if ( class_exists( 'CSF' ) ) {
			...
			CSF::createOptions( $prefix,
				[
					...
					'menu_icon'       => SBP_URL . 'assets/admin/images/icon.svg',
			...
			$is_litespeed       = Helper::isLitespeed();
			...
			$should_disable_caching = Helper::sbpShouldDisableFeature( 'caching' );
			...
			if ( Helper::getOption( 'module_caching' ) && ! defined( 'SBP_ADVANCED_CACHE' ) ) {
			...
			CSF::createSection(
				...
				[
					...
					'id'     => 'caching',
					'icon'   => 'fa fa-server',
					'class'  => Helper::sbpShouldDisableFeature( 'caching' ) ? 'inactive-section' : '',
					'fields' => $cache_fields,
				]
			);
			/* END Section: Caching */
