...
?>
                 ...
                 foreach ( $sbp_options_array as $k => $values ) {
                    $id = strtolower(str_replace(' ','-',$k));
                    ?>
                    <div id="<?php echo $id; ?>" class="sb-pack-tab">
                        <div class="sb-pack" >
                         <?php
                            foreach ( $values as $k_v => $value ) {

                                if ( $value['type'] == 'settings_label' ) {  ?>
                                    <?php echo (isset($value['label'])) ?  '<h3>'.$value['label'].'</h3>' : ''; ?>
                                <?php }

                                if ( $value['type'] == 'checkbox' ) {  ?>
                                    <p>
                                        <input id="sbp_settings[<?php echo $k_v; ?>]" name="sbp_settings[<?php echo $k_v; ?>]"
                                               type="checkbox"
                                               value="1" <?php checked( 1, isset( $sbp_options[ $k_v ] ) ); ?> />
                                ...
                                if ( $value['type'] == 'select' ) { ?>
                                    <p>
                                        ...
                                        <select id="sbp_settings[<?php echo $k_v; ?>]" name="sbp_settings[<?php echo $k_v; ?>]">
                                            <?php
                                            foreach ( $value['options'] as $option_k => $op_v ) {
                                                ?>
                                                <option value="<?php echo $option_k; ?>" <?php selected( $option_k, $sbp_options[ $k_v ], true ); ?> ><?php echo $op_v; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                if ( $value['type'] == 'text' ) { ?>
                                    <p>
                                        <?php $op_text = ( isset( $sbp_options[ $k_v ] ) ) ? $sbp_options[ $k_v ] : ""; ?>
                                        <label for="sbp_settings[<?php echo $k_v; ?>]"><?php echo $value['label']; ?></label>
                                        <span class="tooltip-right"
                                              data-tooltip="<?php echo $value['tooltip']; ?>">
                                            <i class="dashicons dashicons-editor-help"></i>
                                        </span>
                                        <input id="sbp_settings[<?php echo $k_v; ?>]" name="sbp_settings[<?php echo $k_v; ?>]" type="text"
                                               vlue="<?php echo esc_attr( $op_text ); ?>"/>
                                    </p>
                                    <?php
                                }
                                ...
                                if($value['type'] == 'textarea'){ ?>
                                    ...
                                    <p>
                                    <textarea cols="50" rows="3" name="<?php echo $k_v; ?>" id="<?php echo $k_v; ?>"
