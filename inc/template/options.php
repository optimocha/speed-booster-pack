...
', 'sb-pack' );
        ...
        <form method="post" action="options.php">
            ...
            <div id="general-options" class="sb-pack-tab">
                ...
                <p>
                    <input id="sbp_settings[jquery_to_footer]" name="sbp_settings[jquery_to_footer]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['jquery_to_footer'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[use_google_libs]" name="sbp_settings[use_google_libs]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['use_google_libs'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[minify_html_js]" name="sbp_settings[minify_html_js]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['minify_html_js'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[defer_parsing]" name="sbp_settings[defer_parsing]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['defer_parsing'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[query_strings]" name="sbp_settings[query_strings]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['query_strings'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[font_awesome]" name="sbp_settings[font_awesome]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['font_awesome'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[remove_emojis]" name="sbp_settings[remove_emojis]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['remove_emojis'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[remove_wsl]" name="sbp_settings[remove_wsl]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['remove_wsl'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[remove_adjacent]" name="sbp_settings[remove_adjacent]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['remove_adjacent'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[wml_link]" name="sbp_settings[wml_link]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['wml_link'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[rsd_link]" name="sbp_settings[rsd_link]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['rsd_link'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[wp_generator]" name="sbp_settings[wp_generator]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['wp_generator'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[remove_all_feeds]" name="sbp_settings[remove_all_feeds]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['remove_all_feeds'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[disable_xmlrpc]" name="sbp_settings[disable_xmlrpc]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['disable_xmlrpc'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[disable_self_pingbacks]" name="sbp_settings[disable_self_pingbacks]"
                           type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['disable_self_pingbacks'] ) ); ?> />
                    <label for="sbp_settings[disable_self_pingbacks]"><?php _e( 'Disable Self Pingbacks', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'A pingback is a special type of comment that’s created when you link to another blog post, as long as the other blog is set to accept pingbacks. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
                </p>

                <p>
                    <input id="sbp_settings[disable_dashicons]" name="sbp_settings[disable_dashicons]"
                           type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['disable_dashicons'] ) ); ?> />
                    <label for="sbp_settings[disable_dashicons]"><?php _e( 'Disable Dashicons', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'Disable dashicons from front end. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
                </p>

                <p>
                    <input id="sbp_settings[disable_google_maps]" name="sbp_settings[disable_google_maps]"
                           type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['disable_google_maps'] ) ); ?> />
                    <label for="sbp_settings[disable_google_maps]"><?php _e( 'Disable Google Maps', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'Disable Google Maps from front end. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
                </p>

                <p>
                    <input id="sbp_settings[disable_heartbeat]" name="sbp_settings[disable_heartbeat]"
                           type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['disable_heartbeat'] ) ); ?> />
                    <label for="sbp_settings[disable_heartbeat]"><?php _e( 'Disable Heartbeat', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                ...
                <p>
                    <label for="sbp_settings[heartbeat_frequency]"><?php _e( 'Heartbeat frequency', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'Controls how often the Wordpress Heartbeat API is allowed to run. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
                    <select id="sbp_settings[heartbeat_frequency]" name="sbp_settings[heartbeat_frequency]">
                        <option value="15" <?php selected( "15", $sbp_options['heartbeat_frequency'], true ); ?> >15
                            seconds ( default )
                        </option>
                        <option value="30" <?php selected( "30", $sbp_options['heartbeat_frequency'], true ); ?>>30
                            seconds
                        </option>
                        <option value="45" <?php selected( "45", $sbp_options['heartbeat_frequency'], true ); ?>>45
                            seconds
                        </option>
                        <option value="60" <?php selected( "60", $sbp_options['heartbeat_frequency'], true ); ?>>60
                            seconds
                        </option>
                    </select>
                </p>
                ...
                <p>
                    <label for="sbp_settings[limit_post_revisions]"><?php _e( 'Limit Post Revision', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'Controls how often the Wordpress Heartbeat API is allowed to run. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
					<?php $revisions = ( isset( $sbp_options['limit_post_revisions'] ) ) ? $sbp_options['limit_post_revisions'] : ""; ?>
                    <select id="sbp_settings[limit_post_revisions]" name="sbp_settings[limit_post_revisions]">
                        <option value <?php selected( "", $revisions, true ); ?>> Default
                        </option>
                        <option value="1" <?php selected( "1", $revisions, true ); ?> >1</option>
                        <option value="2" <?php selected( "2", $revisions, true ); ?>>2</option>
                        <option value="3" <?php selected( "3", $revisions, true ); ?>>3</option>
                        <option value="4" <?php selected( "4", $revisions, true ); ?>>4</option>
                        <option value="5" <?php selected( "5", $revisions, true ); ?>>5</option>
                        <option value="10" <?php selected( "10", $revisions, true ); ?>>10
                        </option>
                        <option value="15" <?php selected( "5", $revisions, true ); ?>>15
                        </option>
                        <option value="20" <?php selected( "20", $revisions, true ); ?>>20
                        </option>
                        <option value="25" <?php selected( "25", $revisions, true ); ?>>25
                        </option>
                        <option value="30" <?php selected( "30", $revisions, true ); ?>>30
                        </option>
                        <option value="false" <?php selected( "false", $revisions, true ); ?>>
                ...
                <p>
                    <label for="sbp_settings[autosave_interval]"><?php _e( 'Autosave interval', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'Controls how wordpress will autosave posts and pages while editing. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
					<?php $autosave = ( isset( $sbp_options['autosave_interval'] ) ) ? $sbp_options['autosave_interval'] : ""; ?>
                ...
                <p>
                    <input id="sbp_settings[disable_password_strength_meter]"
                           name="sbp_settings[disable_password_strength_meter]"
                           type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['disable_password_strength_meter'] ) ); ?> />
                    <label for="sbp_settings[disable_password_strength_meter]"><?php _e( 'Disable Password Strength Meter', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'Disable Password Strength Meter from front end. ', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
                </p>
                ...
                <p>
                    <input id="sbp_settings[remove_rest_api_links]" name="sbp_settings[remove_rest_api_links]"
                           type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['remove_rest_api_links'] ) ); ?> />
                    <label for="sbp_settings[remove_rest_api_links]"><?php _e( 'Remove REST API Links', 'sb-pack' ); ?></label>
                    <span class="tooltip-right"
                          data-tooltip="<?php echo __( 'The WordPress REST API provides API endpoints for WordPress data types that allow developers to interact with sites remotely by sending and receiving JSON (JavaScript Object Notation) objects.', 'sb-pack' ); ?>">
						<i class="dashicons dashicons-editor-help"></i>
					</span>
                </p>
                ...
                <p>
                    <input id="sbp_css_async" name="sbp_settings[sbp_css_async]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['sbp_css_async'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[sbp_css_minify]" name="sbp_settings[sbp_css_minify]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['sbp_css_minify'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[sbp_footer_css]" name="sbp_settings[sbp_footer_css]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['sbp_footer_css'] ) ); ?> />
                ...
                <p>
                    <input id="sbp_settings[sbp_is_mobile]" name="sbp_settings[sbp_is_mobile]" type="checkbox"
                           value="1" <?php checked( 1, isset( $sbp_options['sbp_is_mobile'] ) ); ?> />
                ...
                <p>
                    <textarea cols="50" rows="3" name="sbp_css_exceptions" id="sbp_css_exceptions"
                                    ...
                                    <div class="inside">
                                        <div class="sbp-inline-wrap">
                                            ...
                                            <i>
                                                ...
                                                <a href="https://docs.machothemes.com/article/119-plugin-options-explained#exclude-scripts-from-being-moved-to-the-footer-50"
                                                   target="_blank"
                                                   title="Documentation"><?php _e( 'detailed instructions', 'sb-pack' ); ?></a> <?php _e( 'on this option on plugin documentation.', 'sb-pack' ); ?>

                                            </i>

                                            <p>
                                                <input type="text" name="sbp_js_footer_exceptions1"
                                                       id="sbp_js_footer_exceptions1"
                                                       value="<?php echo esc_attr( $js_footer_exceptions1 ); ?>"/>
                                            </p>

                                            <p>
                                                <input type="text" name="sbp_js_footer_exceptions2"
                                                       id="sbp_js_footer_exceptions2"
                                                       value="<?php echo esc_attr( $js_footer_exceptions2 ); ?>"/>
                                            </p>

                                            <p>
                                                <input type="text" name="sbp_js_footer_exceptions3"
                                                       id="sbp_js_footer_exceptions3"
                                                       value="<?php echo esc_attr( $js_footer_exceptions3 ); ?>"/>
                                            </p>

                                            <p>
                                                <input type="text" name="sbp_js_footer_exceptions4"
                                                       id="sbp_js_footer_exceptions4"
                                                       value="<?php echo esc_attr( $js_footer_exceptions4 ); ?>"/>
                                            </p>
                            ...
                            <div class="postbox closed" id="defer-from-footer">
                                ...
                                <div class="postbox" id="defer-from-footer">
                                    ...
                                    <div class="inside">
                                        ...
                                        <div class="sbp-inline-wrap">
                                            <p>
                                                <input type="text" class="sbp-more-width" name="sbp_defer_exceptions1"
                                                       id="sbp_defer_exceptions1"
                                                       value="<?php echo $defer_exceptions1; ?>"/>
                                            </p>

                                            <p>
                                                <input type="text" class="sbp-more-width" name="sbp_defer_exceptions2"
                                                       id="sbp_defer_exceptions2"
                                                       value="<?php echo $defer_exceptions2; ?>"/>
                                            </p>

                                            <p>
                                                <input type="text" class="sbp-more-width" name="sbp_defer_exceptions3"
                                                       id="sbp_defer_exceptions3"
                                                       value="<?php echo $defer_exceptions3; ?>"/>
                                            </p>

                                            <p>
                                                <input type="text" class="sbp-more-width" name="sbp_defer_exceptions4"
                                                       id="sbp_defer_exceptions4"
                                                       value="<?php echo $defer_exceptions4; ?>"/>
                                            </p>
                                        </div>
                                        <p class="description">
