                        ...
                        <div class="meta-box-sortables ui-sortable" id="normal-sortables">
                            ...
                            <div class="inside">
                                ...
                                foreach ($section_value['items'] as $item => $item_value) {
                                    ...
                                    if ($item_value['type'] == 'checkbox') { ?>
                                        <p>
                                            <input id="sbp_settings[<?php echo $item; ?>]"
                                                   name="sbp_settings[<?php echo $item; ?>]"
                                                   type="checkbox"
                                    ...
                                    if ($item_value['type'] == 'select') { ?>
                                        <p>
                                            ...
                                            <?php } ?>
                                            <select id="sbp_settings[<?php echo $item; ?>]"
                                                    name="sbp_settings[<?php echo $item; ?>]">
                                                <?php
                                    ...
                                    if ($item_value['type'] == 'text') { ?>
                                        <p>
                                            ...
                                            <label for="<?php echo ($k == 'general-options') ? 'sbp_settings[' . $item . ']' : $item; ?>"><?php echo (isset($item_value['label'])) ? $item_value['label'] : ''; ?></label>
                                            <?php if (isset($item_value['tooltip'])) { ?>
                                                <span class="tooltip-right"
                                                      data-tooltip="<?php echo $item_value['tooltip']; ?>">
                                <i class="dashicons dashicons-editor-help"></i>
                                            ...
                                            <?php } ?>
                                            <input id="<?php echo ($k == 'general-options') ? 'sbp_settings[' . $item . ']' : $item; ?>"
                                                   name="<?php echo ($k == 'general-options') ? 'sbp_settings[' . $item . ']' : $item; ?>"
                                                   type="text"
                                                   value="<?php echo esc_attr($op_text); ?>"/>
                                        </p>
                                    <?php }

                                    if ($item_value['type'] == 'textarea') { ?>
                                        <div class="td-border-last"></div>
                                        <h4><?php echo (isset($item_value['label'])) ? $item_value['label'] : ''; ?></h4>
                                        <p>
                                            <textarea cols="50" rows="3" name="<?php echo $item; ?>"
                                                      id="<?php echo $item; ?>"
