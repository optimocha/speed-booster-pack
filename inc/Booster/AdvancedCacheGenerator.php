...
class AdvancedCacheGenerator
{
    ...
    public static function generate_advanced_cache_file($options = [])
    {
        if ($options === []) {
            $options = [
                'caching_separate_mobile' => Helper::getOption('caching_separate_mobile'),
                'caching_include_query_strings' => Helper::getOption('caching_include_query_strings'),
                'caching_expiry' => Helper::getOption('caching_expiry'),
                'caching_exclude_urls' => Helper::getOption('caching_exclude_urls'),
                'caching_exclude_cookies' => Helper::getOption('caching_exclude_cookies'),
            ];
        }
...
function sbp_explode_lines( $text ) {
    ...
    private static function caching_exclude_cookies()
    {
        ...
        if ($excluded_cookies) {
            $cookies = Helper::explodeLines($excluded_cookies);
